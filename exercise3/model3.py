...
class Model3(BaseModel):
    ...
    def define_model(self, x, y):
        ...
        # first conv layer
        # ONLY CHANGE TO model2 - here the input layer has a filter of depth 5!
        conv1_w = tf.Variable(tf.truncated_normal(shape=[fs1, fs1, self.history_len, nf1], mean=mu, stddev=sigma), name="w1")
